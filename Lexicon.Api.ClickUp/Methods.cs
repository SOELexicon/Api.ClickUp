...
namespace Api.ClickUp
{
    ...
    public class Methods
    {
        ...
        public Methods(string accessToken, string baseAddress = @"Https://api.clickup.com/api/v2/")
        {
        ...
        public static Methods Create(ParamsAccessToken paramAccessToken)
        {
            ...
            return new Methods(accessToken);
        }
        ...
        /// </summary>
        /// <param name="paramAccessToken">param access token object</param>
        public static Task<Methods> CreateAsync(ParamsAccessToken paramAccessToken)
        {
            var client = new RestClient(_baseAddress);
            var request = new RestRequest("oauth/token", Method.POST);
            request.AddParameter("client_id", paramAccessToken.ClientId);
            ...
            // execute the request
            var taskCompletionSource = new TaskCompletionSource<Methods>();
            RestSharperHelper.ExecuteRequestAsync<ResponseAccessToken, ResponseError>(client, request)
               .ContinueWith(responseTask =>
               {
                   ...
                   taskCompletionSource.SetResult(new Methods(accessToken));
               });
        ...
        /// <summary>
        /// Get a space's folders. The folders' lists will aZlso be included.
        /// </summary>
        ...
        public ResponseGeneric<ResponseTasks, ResponseError> GetListTasks(ParamsGetTasks paramsGetTasks)
        {
            var client = new RestClient(_baseAddress);
            var request = new RestRequest($"list/{paramsGetTasks.ListIds.First()}/task", Method.GET);
            request.AddHeader("authorization", AccessToken);
        ...
        public ResponseGeneric<ResponseTimeTracking, ResponseError> GetTimeEntriesByTeamId(ParamsGetTimeEntriesByTeamId paramsGetTimeEntriesByTeamId)
        {
            var client = new RestClient(_baseAddress);
            var request = new RestRequest($"team/{paramsGetTimeEntriesByTeamId.TeamId}/time_entries", Method.GET);
            request.AddHeader("authorization", AccessToken);
            List<Parameter> parameters = paramsGetTimeEntriesByTeamId.GetParametersFromParamsObject();
            ...
            // execute the request
            return RestSharperHelper.ExecuteRequest<ResponseTimeTracking, ResponseError>(client, request);
        }
        ...
        public Task<ResponseGeneric<ResponseTimeTracking, ResponseError>> GetTimeEntriesByTeamIdAsync(ParamsGetTimeEntriesByTeamId paramsGetTimeEntriesByTeamId)
        {
            var client = new RestClient(_baseAddress);
            var request = new RestRequest($"teams/{paramsGetTimeEntriesByTeamId.TeamId}/time_entries", Method.GET);
            request.AddHeader("authorization", AccessToken);
            ...
            // execute the request
            return RestSharperHelper.ExecuteRequestAsync<ResponseTimeTracking, ResponseError>(client, request);
        }
